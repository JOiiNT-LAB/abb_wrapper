...
* Joint Mode
* Pose Mode
* Lead Through Mode (only for collaborative robots)

### Recommendations

* This library has been verified to work with RobotWare version `7.3.1`. Other versions are expected to work.
...
his work is based on the [abb_libegm](https://github.com/ros-industrial/abb_libegm) classes developed by Jon Tjerngren for ABB IRC5 controllers (running RobotWare `6.x`)
